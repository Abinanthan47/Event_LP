...
function Hero() {
  return (
    <div className="h-screen bg-black relative w-full">
      ...
      <h1 className='hidden md:block font-monument text-[24px] md:text-7xl lg:text-7xl font-bold leading-7 md:leading-12 lg:leading-16 text-white mix-blend-difference mb-8 absolute top-[45%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center'>
        <p className='text-sm font-light uppercase tracking-widest  text-white text-center mb-2'>
          Department of Electronics & Communication engineering
        </p>
        FRACTALS & I`VENOR '25
        <div>
          <h3 className='text-4xl  tracking-widest py-7 mb-8 '>
            FEB 27 - 28
          </h3>
        </div>
      </h1>
      <div className='absolute top-[60%]  md:top-[64%] lg:top-[72%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center flex flex-col items-center gap-8'>
        <RegisterButton />
      </div>
